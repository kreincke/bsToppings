...
The **bsToppings** repository shall collect such secondary solutions: It shall offer **MIT licensed snippets for expanding the bootScore functionality**. And it shall describe, how to do that.
